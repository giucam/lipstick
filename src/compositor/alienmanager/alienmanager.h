...
class AlienManagerGlobal : public QWaylandGlobalInterface
{
public:
    AlienManagerGlobal();
...
class AlienManager : public QtWaylandServer::alien_manager
{
public:
    AlienManager(wl_client *client, uint32_t id);
...
class AlienClient : public QtWaylandServer::alien_client
{
public:
    AlienClient(AlienManager *mgr, wl_client *client, uint32_t id, const QString &package);
